...
idtp_data! {
    ...
    pub struct Imu3Acc {
        ...
        pub acc_x: f32,
        /// Acceleration along the Y-axis in meters per second squared (`m/s²`).
        pub acc_y: f32,
        /// Acceleration along the Z-axis in meters per second squared (`m/s²`).
        pub acc_z: f32,
    }
    ...
    pub struct Imu3Gyr {
        ...
        pub gyr_x: f32,
        /// Angular velocity along the Y-axis in radians per second (`rad/s`).
        pub gyr_y: f32,
        /// Angular velocity along the Z-axis in radians per second (`rad/s`).
        pub gyr_z: f32,
    }
    ...
    pub struct Imu3Mag {
        ...
        pub mag_x: f32,
        /// Magnetic field induction along the Y-axis in microteslas (`μT`).
        pub mag_y: f32,
        /// Magnetic field induction along the Z-axis in microteslas (`μT`).
        pub mag_z: f32,
    }
